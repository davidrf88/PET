...
jQuery.fn.motionCaptcha || (function($) {
	...
	$.fn.motionCaptcha.defaults = {
		actionId: '.mc-actionb',     // The ID of the input containing the form action
		divId: '#mcx',               // If you use an ID other than '#mc' for the placeholder, pass it in here
		...
		onError: function($form, $canvas, ctx) {
        	...
        	$submit = $(".HDDCaptcha INPUT");
            $('.errorVerdadero').val("Intenta de nuevo");		
